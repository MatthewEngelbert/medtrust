                        ...
                        <div className="records-grid">
                            {realMedicalRecords.length === 0 ? (
                                <div style={{
                                    ...
                                    <h3 style={{ fontSize: '1.5rem', fontWeight: 'bold', color: '#1e293b', marginBottom: '0.75rem' }}>No Medical Records Found</h3>
                                    <p style={{ fontSize: '1.1rem', color: '#64748b', maxWidth: '400px', lineHeight: '1.6' }}>Your history will appear here once a doctor adds a record.</p>
                                </div>
                            ) : (
